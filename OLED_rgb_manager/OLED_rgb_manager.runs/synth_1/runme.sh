...
HD_PWD='Y:/Cours/Enseirb-E2/pr214/Ccode/Sources/OLED_rgb_manager/OLED_rgb_manager.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_level_test.tcl
