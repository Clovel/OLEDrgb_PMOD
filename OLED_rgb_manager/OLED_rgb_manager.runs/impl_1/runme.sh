...
HD_PWD='Y:/Cours/Enseirb-E2/pr214/Ccode/Sources/OLED_rgb_manager/OLED_rgb_manager.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_level_test.tcl -notrace
