...
#set_property PACKAGE_PIN E16 [get_ports RAZ]						
#set_property IOSTANDARD LVCMOS33 [get_ports RAZ]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
#set_property PACKAGE_PIN F15 [get_ports B_UP]						
...
#set_property PACKAGE_PIN V10 [get_ports B_DOWN]						
#set_property IOSTANDARD LVCMOS33 [get_ports B_DOWN]
